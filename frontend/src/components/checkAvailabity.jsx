  ...
  return (
    <div className='flex justify-around items-center py-10 flex-col md:flex-row'>
      ...
      <label htmlFor="guest">
        ...
        <input type="number" id='guest' className='border-2 rounded-lg h-12 w-44 p-2' onChange={(e)=>setFrom(e.target.value)}/>
      </label>
      <div className='flex items-center gap-6'>
      <label htmlFor="nonac" className='flex gap-4'>
        <p className='uppercase font-bold text-2xl'>Non-AC</p>
        <input type="radio" name='roomtype' id='nonac' className='w-4' value="AC" onChange={(e)=>setFrom(e.target.value)}/>
      </label>
      <label htmlFor="ac" className='flex gap-4'>
        <p className='uppercase font-bold text-2xl'>AC</p>
        <input type="radio" name='roomtype' id='ac' className='w-4' value="Non-AC" onChange={(e)=>setFrom(e.target.value)}/>
      </label>
      </div>
